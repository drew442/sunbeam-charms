...
"""Unit tests for Cinder LVM operator charm class."""
...
class _CinderVolumeLVMOperatorCharm(
    charm.CinderVolumeLVMOperatorCharm
):
...
class TestCinderLVMOperatorCharm(test_utils.CharmTestCase):
    """Test cases for CinderLVMOperatorCharm class."""
